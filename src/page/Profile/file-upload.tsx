...
export const sampleRoomImages: IFile[] = [
  {
    id: "1",
    storage: "local",
    filename_disk: "modern-room.jpg",
    filename_download: "modern-room.jpg",
    title: "Modern Room",
    type: "image/jpeg",
    folder: "rooms",
    uploaded_by: "admin",
  ...
  },
  {
    id: "2",
    storage: "local",
    filename_disk: "cozy-studio-apartment.png",
    filename_download: "cozy-studio-apartment.png",
    title: "Cozy Studio",
    type: "image/png",
    folder: "rooms",
    uploaded_by: "admin",
  ...
  },
  {
    id: "3",
    storage: "local",
    filename_disk: "shared-room.jpg",
    filename_download: "shared-room.jpg",
    title: "Shared Room",
    type: "image/jpeg",
    folder: "rooms",
    uploaded_by: "admin",
  ...
  },
  {
    id: "4",
    storage: "local",
    filename_disk: "luxury-room-city-view.jpg",
    filename_download: "luxury-room-city-view.jpg",
    title: "Luxury Room",
    type: "image/jpeg",
    folder: "rooms",
    uploaded_by: "admin",
...
export const sampleRoomVideo: IFile = {
  id: "video-1",
  storage: "local",
  filename_disk: "room-tour.mp4",
  filename_download: "room-tour.mp4",
